/**
 * Memory Service
 * Manages conversation context and thread persistence
 */
 ...
 * Provides methods for conversation memory management
 */
    ...
    try {
      ...
      const briefing = {
        ...
        summary: `Customer initiated conversation ${thread.metadata.messageCount} messages ago. Current sentiment: ${thread.metadata.sentiment}. ${
          toolsUsed.length > 0
            ? `AI attempted actions: ${toolsUsed.map((t) => t.tool).join(", ")}`
